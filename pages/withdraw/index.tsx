...
const WithdrawPage: NextPage = () => {
  ...
  ] = useInputAmount(wealthBalance.data?.balanceAsNumber ?? 0);
  ...
  if (wealthBalance.isLoading || wealthBalance.isError) {
  ...
  return (
    <>
      <WithdrawPageRender
        availableBalance={wealthBalance.data.balanceAsNumber}
